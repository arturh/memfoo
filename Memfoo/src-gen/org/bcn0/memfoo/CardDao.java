...
public class CardDao extends AbstractDao<Card, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Lesson = new Property(8, Integer.class, "lesson", false, "LESSON");
    };
    ...
    protected void bindValues(SQLiteStatement stmt, Card entity) {
        ...
        Integer lesson = entity.getLesson();
        if (lesson != null) {
            stmt.bindLong(9, lesson);
        }
    }
    ...
    public Card readEntity(Cursor cursor, int offset) {
        Card entity = new Card( //
            ...
            cursor.isNull(offset + 8) ? null : cursor.getInt(offset + 8) // lesson
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Card entity, int offset) {
        ...
        entity.setLesson(cursor.isNull(offset + 8) ? null : cursor.getInt(offset + 8));
     }
